...
<div class="accountcont">
    <div id="payment" class="woocommerce-checkout-payment">
        ...
        <?php if (!empty($available_gateways)) {
          ...
          echo '<div class="bg-danger-subtle text-danger mb-2 py-1 px-2 rounded-2">' .
            apply_filters(
        ...
        <div class="place-order">
            <noscript>
                ...
                <br />
                <button type="submit" class="btn btn-primary btn-sm alt" name="woocommerce_checkout_update_totals"
            ...
            <?php echo apply_filters(
              ...
              '<button type="submit" class="btn btn-primary btn-sm alt" name="woocommerce_checkout_place_order" id="place_order" value="' .
