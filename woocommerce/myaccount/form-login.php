...
<hr>
<div class="u-columns col2-set justify-content-between row accountcont" id="customer_login">
        ...
        <form class="woocommerce-form woocommerce-form-login login" method="post">
            ...
            <div class="row align-items-center">
                <div class="col-sm-4 col-12">
                    <button type="submit"
                        class="woocommerce-button btn btn-sm btn-primary woocommerce-form-login__submit" name="login"
    ...
    <div class="u-column2 col-lg-5 col-md-6 mt-3 col-12">
        ...
        <form method="post" class="woocommerce-form woocommerce-form-register register" <?php do_action(
          'woocommerce_register_form_tag'
            ...
            <button type="submit"
                class="woocommerce-Button woocommerce-button btn btn-primary btn-sm woocommerce-form-register__submit"
