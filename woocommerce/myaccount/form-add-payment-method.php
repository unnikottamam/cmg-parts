...
<form id="add_payment_method" method="post">
    <div id="payment" class="woocommerce-Payment payment_gateways">
  ...
  $gateway->id
        ...
        <div class="form-group">
            ...
            <button type="submit" class="woocommerce-Buttonbtn btn btn-primary btn-sm alt" id="place_order" value="<?php esc_attr_e(
              'Add payment method',
              'woocommerce'
            ); ?>">
