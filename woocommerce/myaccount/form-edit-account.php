...
<form class="woocommerce-EditAccountForm edit-account" action="" method="post" <?php do_action(
  'woocommerce_edit_account_form_tag'
    ...
    <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
        ...
        <input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="account_display_name"
            id="account_display_name" value="<?php echo esc_attr(
              $user->display_name
  ...
  'woocommerce'
    ...
    <p>
        ...
        <button type="submit" class="woocommerce-Button btn btn-primary btn-xs" name="save_account_details" value="<?php esc_attr_e(
          'Save changes',
          'woocommerce'
