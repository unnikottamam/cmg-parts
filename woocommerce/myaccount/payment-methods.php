...
<div class="payment_methods">
    ...
    <div class="payment_method">
        ...
        foreach (
          ...
          ?>
        <div class="payment_method__<?php echo $count; ?>">
            <?php if (
              has_action(
              ...
              echo '<ul class="payment_method__lists d-flex flex-wrap justify-content-lg-end">';
...
<a class="btn btn-primary btn-xs" href="<?php echo esc_url(
