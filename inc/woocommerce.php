...
{
  $html = '<span class="border-2 border-bottom text-primary border-primary-subtle fs-5 fw-bold">' . $price . '</span>';
  return str_replace('woocommerce-Price-currencySymbol', 'fw-normal', $html);
}