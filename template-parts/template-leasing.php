 ...
 */
 ...
 while (have_posts()) {
   the_post();
   ?>
<section class="pt-3 pb-3 py-md-4">
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-lg-5 col-xl-4 col-md-10">
                <h2 class="fs-4 mb-2 text-success">
                ...
                <div class="p-3 shadow-lg border border-2 border-success-subtle rounded-4">
                ...
                <div class="text-center text-md-start mt-3 pt-3 border-top border-secondary">
                    <img class="shadow-lg" width="264" height="48"
                        src="<?php echo get_template_directory_uri(); ?>/images/used-machinery-finance-quip.jpg"
                        alt="used machinery finance">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-7 col-xl-6 col-12">
                ...
                <p class="m-0">Seamlessly engage with our dedicated Sales Team to receive expert guidance on any
                    inquiries or requirements concerning our extensive range of used machinery. <br>
                    <strong>Your success stands as our topmost priority!</strong>
                </p>
            </div>
        </div>
    </div>
</section>
<section class="py-3 py-md-4 bg-success-subtle bg-gradient border-top">
    <div class="container fw-bold">
        <ul class="list-unstyled row row-gap-3 fs-5 m-0 justify-content-center">
            <li class="col-xl-3 col-md-4 col-12">
                ...
                <a class="d-block mt-2" href="tel:+1 (866) 306-3330">
                    <div class="d-flex align-items-center column-gap-1">
                        <svg width="16" height="16" viewBox="0 0 16 16">
                            <path
                                d="M11 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1zM5 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2z">
